...
http.createServer((req, res) => { res.end('WinGo Sniper Pro - Clear Display'); }).listen(process.env.PORT || 8080);
...
// Auto Bet Function with clear message
...
console.log("✅ Bot is running - Clear display mode");
